    ...
    return (
        <div className="relative">
            ...
            <div className="grid grid-cols-3 gap-x-3 borderImp rounded-md p-2">
                ...
                <div className='flex flex-col my-2'>
                    <label className="" htmlFor="category">Prepared by:</label>
                    <SelectField
                        placeholder="Select product"
                        onChange={value => setPrepared(value)}
                    >
                ...
                <div className='my-2 flex flex-col w-full'>
                    <label htmlFor="date" className="">Quotation Valid till: </label>
                    <div className="border rounded-md">
                        <DatePicker className="w-full" bordered={false} onChange={(date, dateString) => {
                            setQuotationValid(dateString)
                        }}
                        />
                    </div>
                </div>
