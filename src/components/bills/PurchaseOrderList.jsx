...
import { purchaseListColumn } from '../../data/table/BillsTable'
...
const PurchaseOrderList = ({ add, setAdd, igstRate, sgstRate, cgstRate, utgstRate, tax }) => {
    ...
    return (
        <div>
            ...
            <div className="borderImp rounded-md text-xs">
                ...
                <div className="p-1">
                    <Table columns={purchaseListColumn} dataSource={itemList} />
                </div>
            </div>
            <div className="mt-5">
                <p>Total Amount: <span>₹ 45,000</span></p>
                <p>CGST: <span>₹ 450</span></p>
                <p>IGST: <span>₹ 400</span></p>
                <p>SGST: <span>₹ 400</span></p>
                <p>UTGST: <span>₹ 400</span></p>
                <p>Grand Total: <span>₹ 47,050</span></p>
            </div>
        </div>
    )
}
